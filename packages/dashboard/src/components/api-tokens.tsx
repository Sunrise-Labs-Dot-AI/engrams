                ...
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-[var(--color-text-muted)] font-mono">
                      {t.tokenPrefix}...
                      {isExpired && (
                        <span className="text-[var(--color-danger)] ml-1">expired</span>
                      )}
                    </div>
                  </div>
                </div>
        ...
        {createdToken ? (
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              <code className="flex-1 rounded border border-[var(--color-border)] bg-[var(--color-bg)] px-3 py-2 text-xs font-mono break-all">
                {createdToken}
              </code>
